...
In the terminal, run this command: <code>sudo /opt/bitnami/bncert-tool</code>
...
Open the <b>terminal window</b> of <b>WordPress instance</b>.<br>
    <picture><img width="400rem" src="./assets/wordpress-terminal.png"></picture><br><br>
Run this command to get the password:<code>cat $HOME/bitnami_application_password</code>
